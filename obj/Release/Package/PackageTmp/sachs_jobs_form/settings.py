"""
Django settings for sachs_jobs_form project.
...
SECRET_KEY = '(-o2f-3z0i5#^241qx5ui#fr36*5k3wty*dir7mbwugl66ib5@'
...
ROOT_URLCONF = 'sachs_jobs_form.urls'
...
WSGI_APPLICATION = 'sachs_jobs_form.wsgi.application'
...
BOOTSTRAP3 = {
    ...
    'css_url': 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css',

    # The complete URL to the Bootstrap CSS file (None means no theme)
    # 'theme_url': 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.min.css',

    # The complete URL to the Bootstrap JavaScript file (None means derive it from base_url)
    'javascript_url': 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js',
...
EMAIL_MESSAGE_RECIPIENTS = os.environ.get('EMAIL_MESSAGE_RECIPIENTS', 'abiezerm@gmail.com').split(', ')